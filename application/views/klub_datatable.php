		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										<li class="active"><a href="#">Data Klub</a></li>
									</ul>
									<ul class="nav navbar-nav">
										<li ><a href="#">Data Pemain</a></li>
									</ul>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<h1>Daftar Klub</h1>	
						<br>	
						<a href="<?php echo site_url('klub/create') ?>" type="button" class="btn btn-danger">Create Data Klub</a>	
						<br><br><br>
